...
function Solve_OptiPlant_LP_2obj(opt_data, solver;
  ...
  objectives[:emissions_CO2e_regulated] = @expression(Model_LP, sum(pd.CO2_profile_regulated[sd.Grid_CO2_regulated_p[u],t]*Bought[sd.Grid_buy[u],Time[t]] for u=1:sd.nGCO2reg,t=1:T if sd.Grid_CO2_regulated_p[u] > 0)
