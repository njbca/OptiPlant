...
st.set_page_config(page_title="Scenario Comparison Dashboard", layout="wide")

# Path to the folder containing scenario CSV files
main_results_folder = "C:\\GitHub\\OptiPlant.jl\\results\\Greenlab\\All_fuels_PhD\\Main results\\"

# Find scenario CSV files in the folder
csv_files = [f for f in os.listdir(main_results_folder) if f.lower().startswith('scenario') and f.lower().endswith('.csv')]
...
selected_col = st.sidebar.selectbox(
    "Select concept to compare (e.g., CAPEX, Installed Capacity):",
...
selected_techs = st.sidebar.multiselect("Technologies to include:", techs, default=[])
...
# 2. Run: streamlit run src/PlotGraphs/dashboard_Scenarios.py
# =============================================