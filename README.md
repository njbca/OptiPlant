...
- **[STABLE](https://njbca.github.io/OptiPlant/stable/)** — most recently tagged version of the documentation.
- **[LATEST](https://njbca.github.io/OptiPlant/latest/)** — in-development version of the documentation.
